...
import com.ebixcash.aayu.serviceImpl.GenerateAmortTenorServiceImpl;
import com.fasterxml.jackson.databind.ObjectMapper;

@AutoConfigureMockMvc
@SpringBootTest
public class GenerateAmortTenorControllerTest {

	@Autowired
	private MockMvc mockMvc;

	@Autowired
	GenerateAmortTenorServiceImpl amortTenorService;

	private final ObjectMapper objectMapper = new ObjectMapper();

	@Test
	void getTenor() throws Exception {

		// Load JSON request from file
		String inputJson = loadJSONRequestFromFile("AmortTenorRequest.json");
		String outputJson = loadJSONRequestFromFile("AmortTenorResponse.json");
		...
		MvcResult mvcResult = mockMvc
				.perform(MockMvcRequestBuilders.post("/aayu/v1/amortTenor").contentType(MediaType.APPLICATION_JSON)
