...
@SpringBootTest
public class AmortInterestControllerTest {
	...
	@Test
	void getAmortInterest() throws Exception {
		// Load JSON request from file
		String inputJson = loadJSONRequestFromFile("AmortInterestRequest.json");
		String outputJson = loadJSONRequestFromFile("AmortInterestResponse.json");
		...
		MvcResult mvcResult = mockMvc
				.perform(MockMvcRequestBuilders.post("/aayu/v1/amortInterest").contentType(MediaType.APPLICATION_JSON)
