...
@SpringBootTest
class GenerateAmortControllerTest {
    ...
    void getAmort() throws Exception {
        ...
        String inputJson = loadJSONRequestFromFile("generateAmortRequest.json");
        String outputJson = loadJSONRequestFromFile("generateAmortResponse.json");
        ...
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.post("/aayu/v1/generateAmort")
