...
import com.ebixcash.aayu.serviceImpl.AmortEMIServiceImpl;
import com.fasterxml.jackson.databind.ObjectMapper;

@AutoConfigureMockMvc
@SpringBootTest
public class AmortEMIControllerTest {

	@Autowired
	private MockMvc mockMvc;

	@Autowired
	AmortEMIServiceImpl amortEMIServiceImpl;
	...
	void getTenor() throws Exception {
		...
		String inputJson = loadJSONRequestFromFile("AmortEMIRequest.json");
		String outputJson = loadJSONRequestFromFile("AmortEMIResponse.json");
		...
		MvcResult mvcResult = mockMvc
				.perform(MockMvcRequestBuilders.post("/aayu/v1/amortEmi").contentType(MediaType.APPLICATION_JSON)
