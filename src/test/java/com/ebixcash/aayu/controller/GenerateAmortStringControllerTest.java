...
@SpringBootTest
class GenerateAmortStringControllerTest {
    ...
    @Autowired
    private GenerateAmortServiceImpl generateAmortService; // Actual service implementation


    @Test
    void getAmort() throws Exception {
        // Load JSON request from file
        String inputJson = loadJSONRequestFromFile("generateAmortStringRequest.json");
        String outputJson = loadJSONRequestFromFile("generateAmortStringResponse.json");
        ...
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.post("/aayu/v1/generateAmortString")
