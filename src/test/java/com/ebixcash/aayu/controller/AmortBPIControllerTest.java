...
import com.ebixcash.aayu.serviceImpl.AmortBPIServiceImpl;
import com.fasterxml.jackson.databind.ObjectMapper;

@AutoConfigureMockMvc
@SpringBootTest
public class AmortBPIControllerTest {

	@Autowired
	private MockMvc mockMvc;

	@Autowired
	private AmortBPIServiceImpl amortBPIServiceImpl; // Mocked service
	...
	void getAmortBPITest() throws Exception {
		...
		String inputJson = loadJSONRequestFromFile("AmortBPIRequest.json");
		String outputJson = loadJSONRequestFromFile("AmortBPIResponse.json");
		...
		MvcResult mvcResult = mockMvc
				.perform(MockMvcRequestBuilders.post("/aayu/v1/amortBpi").contentType(MediaType.APPLICATION_JSON)
