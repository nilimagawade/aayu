...
import com.ebixcash.aayu.serviceImpl.AmortInstallmentServiceImpl;
import com.fasterxml.jackson.databind.ObjectMapper;

@AutoConfigureMockMvc
@SpringBootTest
public class GenerateAmortInstallmentControllerTest {
	...
	@Autowired
	private AmortInstallmentServiceImpl amortInstallmentService; // Actual service implementation

	@Test
	void getAmort() throws Exception {
		// Load JSON request from file
		String inputJson = loadJSONRequestFromFile("AmortInstallmentRequest.json");
		String outputJson = loadJSONRequestFromFile("AmortInstallmentResponse.json");
		...
		MvcResult mvcResult = mockMvc
				.perform(MockMvcRequestBuilders.post("/aayu/v1/amortInstallment").contentType(MediaType.APPLICATION_JSON)
